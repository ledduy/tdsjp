...
NUM_POS=241  # exact number of pos samples --> check with viewAnnotation2.php
WIDTH=30
HEIGHT=30
...
NUM_POS=241 #
#NUM_NEG=250 --> small number = easy to reach --> small number of features per stage
NUM_NEG=500
NUM_STAGES=18 # NEG count : acceptanceRatio    500 : 4.32e-08

NUM_NEG=250
NUM_STAGES=19  # NEG count : acceptanceRatio    250 : 1.11925e-08
