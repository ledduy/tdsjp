...
# numPos: 321 - http://192.168.28.68/html/viewAnnotation2.php?labelName=blueguide&trialName=Train3
# numNeg: 2067 - Train3/neg-blueguidex2.dat2
TRIAL_NAME=Train3
...
NUM_POS=321  # exact number of pos samples --> check with viewAnnotation2.php
WIDTH=40
HEIGHT=40
