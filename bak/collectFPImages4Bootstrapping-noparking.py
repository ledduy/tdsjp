...
#root_dir = '/Users/ledduy/tdsjp'
root_dir = '/home/mmlab/mbase/tdsjp'
...
model_dir = '{}/code/Train2/noparking-DETECTOR/cascade.xml'.format(root_dir)
...
file_output = '{}-bs.txt'.format(video_name)  # collection of LabelMeAnnTool for boostrapping round
...
f.close()
dest_dir = '/var/www/html/LabelMeAnnotationTool/annotationCache/DirLists/'
cmd = 'cp {} {}'.format(file_output, dest_dir)
os.system(cmd)
